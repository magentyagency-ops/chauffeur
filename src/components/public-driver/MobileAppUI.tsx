            ...
            <AnimatePresence mode="wait">
              {!activeBookingId ? (
                ...
                >
                  ...
                  {/* Pickup */}
                  <div className="flex items-center gap-3 p-4 rounded-2xl relative">
                    ...
                    <input 
                      ...
                      className="bg-transparent border-none text-white placeholder-gray-500 focus:ring-0 text-lg font-medium w-full p-0"
                    />
                    <button 
                      onClick={() => {
                  ...
                  {/* Dropoff */}
                  <div className="flex items-center gap-3 p-4 rounded-2xl relative">
                    <div className="w-2.5 h-2.5 bg-white shadow-[0_0_10px_rgba(255,255,255,0.3)]" />
                    <input 
                      type="text" 
                  ...
                  {/* Date/Time Picker Modal (Simplified Inline) */}
                  {showDatePicker && (
                    <motion.div 
