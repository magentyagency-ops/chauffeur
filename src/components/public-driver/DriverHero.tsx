  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-5">
        <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-surface-alt flex items-center justify-center font-bold text-foreground text-2xl md:text-3xl border border-border shrink-0 relative">
          {driver.firstName.charAt(0)}
          {isAvailabilityActive(availability) && (
            <span className="absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full bg-success border-[3px] border-background" />
          )}
        </div>
